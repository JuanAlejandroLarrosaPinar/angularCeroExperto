...
export class Convert {
    public static toWelcome(json: string): PaisSmall[] {
        return cast(JSON.parse(json), a(r("Welcome")));
    }

    public static welcomeToJson(value: PaisSmall[]): string {
...
const typeMap: any = {
    ...
    "NativeName": o([
        { json: "eng", js: "eng", typ: u(undefined, r("Eng")) },
        { json: "por", js: "por", typ: u(undefined, r("Eng")) },
    ], false),
    "Eng": o([
        { json: "official", js: "official", typ: "" },
        { json: "common", js: "common", typ: "" },
